 ...
 */
@class INAppStoreWindowDelegateProxy;
@class INMovableByBackgroundContainerView;
...
@interface INAppStoreWindow : NSWindow
{
    ...
    INAppStoreWindowBackgroundDrawingBlock _titleBarDrawingBlock;
    INAppStoreWindowBackgroundDrawingBlock _bottomBarDrawingBlock;
}
...
/**
 ...
 (textured, etc.).
 */
@property (nonatomic, retain) NSView *bottomBarView;
 ...
 */
@property (nonatomic, retain) INWindowButton *closeButton;

/**
 The button to use as the window's minimize button.
 If this property is nil, the default button will be used.
 */
@property (nonatomic, retain) INWindowButton *minimizeButton;

/**
 The button to use as the window's zoom button.
 If this property is nil, the default button will be used.
 */
@property (nonatomic, retain) INWindowButton *zoomButton;

/**
 The button to use as the window's fullscreen button.
 If this property is nil, the default button will be used.
 */
@property (nonatomic, retain) INWindowButton *fullScreenButton;
 ...
 */
@property (nonatomic, retain) NSGradient *titleBarGradient;
...
/**
 ...
 If this property is \c nil, the default color will be used.
 */
@property (nonatomic, retain) NSColor *titleTextColor;
 ...
 */
@property (nonatomic, retain) NSShadow *titleTextShadow;
...
/**
 ...
 If this property is \c nil, the system gradient will be used.
 */
@property (nonatomic, retain) NSGradient *inactiveTitleBarGradient;
...
/**
 ...
 If this property is \c nil, the default color will be used.
 */
@property (nonatomic, retain) NSColor *inactiveBaselineSeparatorColor;
...
/**
 ...
 If this property is \c nil, the default color will be used.
 */
@property (nonatomic, retain) NSColor *inactiveTitleTextColor;
...
/**
 ...
 If this property is \c nil, the default shadow will be used.
 */
@property (nonatomic, retain) NSShadow *inactiveTitleTextShadow;
